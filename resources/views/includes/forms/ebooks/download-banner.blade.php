<!--<script src="/js/megaTracker.js"></script>-->

<script>var tracker=getUrl();</script>



<form method="post" class="form-popup form-parsley" action="/interiors/design-books/includes/banner-response.php" data-validate="parsley">

    

    <input type="hidden" name="ebook_name" value="How to Select Chandelier" />

    <input type="hidden" name="ebook_slug" value="How-to-Select-Chandelier" />
    ...
    <input type="text" name="inputInterested" class="inputInterested" style="display:none;">
 ...
 <div class="input-block">
    ...
    <button type="submit" class="btn-request-ebook">DOWNLOAD NOW</button>
