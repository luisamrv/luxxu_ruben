...
<form id="contact-form-page" data-parsley-validate action="includes/process/process-general-inquire.php" method="post" class="col-sm-12 col-xs-12 col-md-12 col-lg-12 nopadding" style="margin-top: 25px;">
